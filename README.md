...
| — ✅ | **autonomous behaviour frozen** + [`RUNBOOK.md`](RUNBOOK.md) + read-only `pilot report` + **full-chain integration tests** (real executor → real drill manifest → subprocess → verify → lifecycle → report; no live server, no LLM) | — |
